...
enum offsets_index {
	...
	OFFSET_IDX_HENC_HTTP2_CLIENT_CONN,
	OFFSET_IDX_EVICT_COUNT_HPACK_HEADER_FIELD_TABLE,
	OFFSET_IDX_FR_HTTP2_CLIENT_CONN,
	OFFSET_IDX_READ_META_HEADERS_HTTP2_FRAMER,
	OFFSET_IDX_FRAMER_HTTP2_CLIENT_CONN,
	OFFSET_IDX_HPACK_ENCODER_HTTP2_CLIENT_CONN,
	OFFSET_IDX_MAX,
};
